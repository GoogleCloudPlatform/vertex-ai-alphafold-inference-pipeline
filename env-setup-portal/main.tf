...
terraform {
  ...
  provider_meta "google" {
    module_name = "cloud-solutions/alphafold-portal-v1.0"
  }
}
provider "google" {
...
locals {
  service_image_tag = var.is_gcr_io_repo == "true" ? "gcr.io/${var.project_id}/${var.cloud_run_service_name}:latest" : "${var.region}-docker.pkg.dev/${var.project_id}/${var.ar_repo_name}/${var.cloud_run_service_name}:latest" 
}
