...
DATA_PIPELINE_MACHINE_TYPE = os.getenv(
    'DATA_PIPELINE_MACHINE_TYPE', 'c2-standard-30')
...
# PREDICT_MACHINE_TYPE = os.getenv('PREDICT_MACHINE_TYPE', 'g2-standard-8')
...
# RELAX_MACHINE_TYPE = os.getenv('RELAX_MACHINE_TYPE', 'g2-standard-8')
